...
public class updateMyParent extends JDialog {
	...
	public static void main(String[] args) {
		try {
			updateMyParent dialog = new updateMyParent();
	...
	public updateMyParent() {
		...
		}
		{
			...
			textField.setText(mm.getMyDrinkParenNtame());
		}
		{
		...
		}
		{
			...
			textField_1.setText(mm.getMyDrinkParentDescription());
		}
				...
				okButton.addMouseListener(new MouseAdapter() {
					...
					public void mouseClicked(MouseEvent e) {
						if(textField.getText().trim().isEmpty())
							 JOptionPane.showMessageDialog(updateMyParent.this, "名稱不可空白!", "錯誤", JOptionPane.ERROR_MESSAGE);
						else
						{
						
						  List<myDrinkParent> l = mpi.selectByDrinkParenNtame(textField.getText());
						  System.out.println("找到筆數="+l.size());
						  System.out.println("目前類別名稱="+mm.getMyDrinkParenNtame());
						  System.out.println("要更改為:"+textField.getText());
						  // 名稱重複
						  if (l.size()!=0 && !(mm.getMyDrinkParenNtame().equals(textField.getText()))) {
						 	JOptionPane.showMessageDialog(updateMyParent.this, "已有相同類別名稱", "錯誤", JOptionPane.ERROR_MESSAGE);
						  }
						  else
						  { 
							
						 	//修改大分類資料
							mm.setMyDrinkParenNtame(textField.getText());
							mm.setMyDrinkParentDescription(textField_1.getText());
							mm.setMyDrinkParentCategory("");							
							System.out.println("ParentID=" + mm.getMyDrinkParenid());
							mpi.update(mm);
							JOptionPane.showMessageDialog(updateMyParent.this, "修改資料成功");
